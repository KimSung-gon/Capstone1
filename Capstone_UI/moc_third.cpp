...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "third\0on_pushButton_clicked\0"
};
...
const QMetaObject third::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_third.data,
      qt_meta_data_third,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *third::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_third.stringdata0))
        return static_cast<void*>(const_cast< third*>(this));
