...
"background-color: rgb(255, 113, 19);"));
        ...
        graphicsView_2->setGeometry(QRect(0, 0, 401, 111));
    ...
    {
        project->setWindowTitle(QApplication::translate("project", "Login", 0));
#ifndef QT_NO_ACCESSIBILITY
        pushButton->setAccessibleDescription(QString());
#endif // QT_NO_ACCESSIBILITY
        pushButton->setText(QApplication::translate("project", "LogIn", 0));
        pushButton->setShortcut(QString());
        lineEdit_2->setText(QString());
        lineEdit_2->setPlaceholderText(QApplication::translate("project", "Password...", 0));
        lineEdit_2->setProperty("2", QVariant(QString()));
        lineEdit_3->setInputMask(QString());
        lineEdit_3->setPlaceholderText(QApplication::translate("project", "Root Password...", 0));
#ifndef QT_NO_ACCESSIBILITY
        lineEdit->setAccessibleDescription(QString());
#endif // QT_NO_ACCESSIBILITY
        lineEdit->setInputMask(QString());
        lineEdit->setText(QString());
        lineEdit->setPlaceholderText(QApplication::translate("project", "Username...", 0));
        lineEdit->setProperty("1", QVariant(QString()));
        label->setText(QApplication::translate("project", "Lock Insider", 0));
        label_2->setText(QApplication::translate("project", "Enter your Username and Password...", 0));
